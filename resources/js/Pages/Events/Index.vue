                        ...
                        <div v-if="events.meta" class="container pt-8 pb-4 px-4 mx-auto flex justify-center select-none">
                            <template v-if="events.meta">
                                <a
                                    ...
                                    @click.prevent="changePage(events.meta.current_page - 1)"
                                    href="#"
                                ...
                                <template v-for="page in generatePageNumbers(events.meta)" :key="page">
                                    <a
                                        v-if="page !== '...'"
                                        ...
                                        :class="[
                                            ...
                                            { 'bg-indigo-500 text-white': page === events.meta.current_page }
                                        ]"
                                    >
                                        {{ page }}
                                    </a>
...
export default {
    ...
    setup(props) {
        ...
        console.log('Initial events data:', events.value);
        ...
        const searchEvents = async (page = 1) => {
            try {
                ...
                console.log('Updated events data:', events.value);
            } catch (error) {
        ...
        const changePage = (page) => {
            if (page >= 1 && page <= events.value.meta.last_page) {
                searchEvents(page);
            }
        };
