...
<!--                                Add Event-->
<!--                            </a>-->
<!--                            &lt;!&ndash;                            <input v-model="search" @input="searchEvents" type="search" class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" placeholder="Search events">&ndash;&gt;-->
<!--                            <input-->
<!--                                class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"-->
<!--                                placeholder="Search events">-->
<!--                        </div>-->
<!--                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">-->
<!--                            &lt;!&ndash; Use a loop to render events here &ndash;&gt;-->
...
<!--                        </div>-->
<!--                        &lt;!&ndash; Add pagination component &ndash;&gt;-->
<!--                        <div class="mt-8">-->
<!--                            <TailwindPagination-->
<!--                                :data="events"-->
